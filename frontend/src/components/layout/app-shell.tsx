  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-[1600px]">
        <aside className="sticky top-0 hidden h-screen w-60 shrink-0 flex-col border-r border-zinc-800/80 bg-zinc-950/80 px-4 py-6 backdrop-blur md:flex">
          ...
          <header className="sticky top-0 z-20 border-b border-zinc-800/80 bg-zinc-950/85 backdrop-blur">
            <div className="flex items-center justify-between gap-4 px-4 py-3 md:px-8">
              ...
              <div className="hidden text-sm text-zinc-400 md:block">
                European football · Consensus edge detection
              </div>
